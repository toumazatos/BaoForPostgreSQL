...
# specific_query: eg. q8_6a505, specific_instances: eg. 45 (guarantee that q8 appears 45 times in the workload)
...
specific_query = sys.argv[-2] # can also be left blank
specific_query_instances = int(sys.argv[-1]) # can also be left blank (or 0)
